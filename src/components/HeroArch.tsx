...
export function HeroArch({ intensified = false }: { intensified?: boolean }) {
  ...
  return (
    <div ref={rootRef} className={`hero-arch${intensified ? " hero-arch--intense" : ""}`} style={{ "--parallax": 0 } as React.CSSProperties}>
