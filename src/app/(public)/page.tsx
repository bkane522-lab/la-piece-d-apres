...
export default function Home() {
  return (
    <main>
      {/* HERO MOBILE — porte dominante, plein écran, révélation progressive */}
      <div className="hero-mobile-only">
        <HomeHeroMobile />
      </div>

      {/* HERO DESKTOP — nav publique conservée pour le SEO */}
      <section className="hero-desktop-only relative overflow-hidden bg-[var(--chocolate)] py-24 text-[var(--warm-ivory)] lg:py-32">
